  ...
  return (
    ...
    {!p.user ? (
      ...
      <div>
        ...
        {/* No cloud-sync toggles by design (owner, 2026-07-23): signed in to the BRVG cloud ⇒ always
            sync. SyncModal only skips when `lt_sync_cloud` is explicitly 'false', which nothing writes
            any more, so sync is simply on. */}
